...
from uu.subscribe.interfaces import IUIDStrategy
from uu.inviting.interfaces import IMailRecipient
from uu.inviting.mail import MailRecipient, invitation_sender
